...
function [t,y] = pole_place_mass_spring(m, k, y_setpoint, y0)
  ...
  eigs =[-8 ; -10] ;                    ## Initialise desired eigenvalues
...
function [t,y] = lqr_mass_spring(m, k, y_setpoint, y0)
  ...
  Q =[100 0;0 200] ;                  ## Initialise desired eigenvalues
...
function mass_spring_main()
  ...
  #mass_spring_main()[t,y] = sim_mass_spring(m,k, y0);      ## Test mass spring system with no input
